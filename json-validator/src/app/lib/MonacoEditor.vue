...
export default defineComponent({
          ...
          if (editorUri) {
            ...
            if (currentEditorHasMarkerChanges) {
              ...
              const errors = markers.map((marker) => {
                return `row ${marker.startLineNumber}, col ${marker.startColumn}: ${marker.message} `;
              });
              this.$emit('onValidate', errors, markers);
            }
          }
        });
  ...
  watch: {
    ...
    errorMarker() {
      if (this.errorMarker !== undefined && this.errorMarker !== null) {

        this.editor.setSelection(
          new monaco.Selection(
            this.errorMarker.startLineNumber,
            this.errorMarker.startColumn,
            this.errorMarker.endLineNumber,
            this.errorMarker.endColumn
          )
        );
        this.editor.focus();
      }
